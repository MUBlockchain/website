    ...
    return (
        <div>
            ...
            <div id="conference-2019">
                <img src={require('../../static/assets/images/conference_banner.jpg')} alt="Piggy Bank"/>
                    ...
                    <Carousel id="conference-2019__slideshow">
                        <Carousel.Item>
                            <img
                                ...
                                src={require('../../static/assets/images/conference_slideshow_1.jpg')}
                                alt="First slide"
                            />
                        </Carousel.Item>
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_2.jpg')}
                                alt="Second Slide"
                            />
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow3.jpg')}
                                alt="Third slide"
                            />
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_4.jpg')}
                                alt="Fourth slide"
                            />
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_5.jpg')}
                                alt="Fifth slide"
                            />
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_6.jpg')}
                                alt="Sixth slide"
                            />
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_7.jpg')}
                                alt="Seventh slide"
                            />
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_8.jpg')}
                                alt="Eigth slide"
                            />
                        </Carousel.Item>
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_9.jpg')}
                                alt="Ninth slide"
                            />
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_10.jpg')}
                                alt="Tenth slide"
                            />
                        </Carousel.Item>
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_11.jpg')}
                                alt="Eleventh slide"
                            />
                        </Carousel.Item>
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_12.jpg')}
                                alt="Twelfth slide"
                            />
                            <Carousel.Caption>
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_13.jpg')}
                        ...
                        <Carousel.Item>
                            <img
                                className="conference-2019__slideshow_image"
                                src={require('../../static/assets/images/conference_slideshow_14.jpg')}
                ...
                <div className="conference-2019__guests">
                    ...
                    <div>
                        <div>
                            <img src={require('../../static/assets/images/luke_sully.png')} alt="Luke Sully"/>
                            <h4>Luke Sully</h4>
                ...
                <div className="conference-2019__guests">
                    ...
                    <div>
                        <div>
                            <img src={require('../../static/assets/images/wendy_henry.jpg')} alt="Wendy Henry"/>
                            <h4>Wendy Henry</h4>
                        ...
                        <div>
                            <img src={require('../../static/assets/images/vasanthi_chalasani.png')} alt="Vasanthi Chalasani"/>
                        ...
                        <div>
                            <img src={require('../../static/assets/images/chris_berry.png')} alt="Chris Berry"/>
                            <h4>Chris Berry</h4>
                ...
                <div className="conference-2019__guests">
                    ...
                    <div>
                        <div>
                            <img src={require('../../static/assets/images/charlier_lougheed.jpg')} alt="Charlie Lougheed"/>
                        ...
                        <div>
                            <img src={require('../../static/assets/images/john_squires.jpg')} alt="Block Key Capital"/>
                            <h4>John Squires</h4>
                        ...
                        <div>
                            <img src={require('../../static/assets/images/michael_hiles.jpg')} alt="Clever Apply"/>
                            <h4>Michael Hiles</h4>
                ...
                <div className="conference-2019__guests">
                    ...
                    <div>
                        <div>
                            <img src={require('../../static/assets/images/clever_apply.png')} alt="Clever Apply"/>
                            <h4>CleverApply</h4>
                        ...
                        <div>
                            <img src={require('../../static/assets/images/block_key_capital_logo.png')} alt="Block Key Capital"/>
                        ...
                        <div>
                            <img src={require('../../static/assets/images/blox_logo.png')} alt="Clever Apply"/>
