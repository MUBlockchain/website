  ...
  <div>
    ...
    <div className="leadership-team__row">
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/jack_gilcrest.jpeg")} alt="Jack Gilcrest"/>
        <p>Jack Gilcrest</p>
        <p>President</p>
      ...
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/alexandra_bartkoske.jpg")} alt="Alexandra Bartkoske"/>
      ...
      <div className="leadership-team__column">
        <img src={require('../../static/assets/images/alex_stan.jpg')} alt="Alex Stan"/>
        <p>Alex Stan</p>
    ...
    <div className="leadership-team__row">
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/peter_cook.jpg")} alt="Peter Cooke"/>
        <p>Peter Cooke</p>
        <p>VP of Projects</p>
      ...
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/allie_blackburn.jpg")} alt="Allie Blackburn"/>
        <p>Allie Blackburn</p>
      ...
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/torsten_overbeck.jpg")} alt="Torsten Overbeck"/>
    ...
    <div className="leadership-team__row">
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/sam_groth.jpg")} alt="Sam Groth"/>
        <p>Sam Groth</p>
      ...
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/adrian_czajka.jpg")}/>
        <p>Adrian Czajka</p>
      ...
      <div className="leadership-team__column">
        <img src={require("../../static/assets/images/jake_dearth.jpg")}/>
        <p>Jake Dearth</p>
        <p>VP of Outreach</p>
    ...
    <div className="leadership-team__strategic-advisors">
      ...
      <div className="leadership-team__row">
        <div className="leadership-team__strategic-advisors__column">
          <img src={require("../../static/assets/images/arthur_carvalho.jpg")} alt="Dr. Arthur Carvalho"/>
        ...
        <div className="leadership-team__strategic-advisors__column">
          <img src={require("../../static/assets/images/ashton_barger.jpg")} alt="Ashton Barger"/>
          <p>Ashton Barger</p>
      ...
      <div className="leadership-team__row">
        <div className="leadership-team__strategic-advisors__column">
          <img src={require("../../static/assets/images/jeffrey_w_merhout.jpg")} alt="Jeffrey W. Merhout"/>
        ...
        <div className="leadership-team__strategic-advisors__column">
          <img src={require("../../static/assets/images/patrick_young.jpg")} alt="Patrick Young"/>
          <p>Patrick Young</p>
          <p>Strategic Advisor</p>
